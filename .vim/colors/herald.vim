...
if has("gui_running")
	...
	" -> Code
	hi Comment        guibg=#1F1F1F guifg=#5FB1CC gui=none
	hi Constant       guibg=#1F1F1F guifg=#FC4234 gui=none
	hi String         guibg=#1F1F1F guifg=#FFB539 gui=none
	hi Error          guibg=#000000 guifg=#FF0000 gui=bold
	...
	hi Special        guibg=#1F1F1F guifg=#FC4234 gui=none
	hi Todo           guibg=#1F1F1F guifg=#FC4234 gui=bold,underline
    ...
    hi hgstTrace      guibg=#1F1F1F guifg=#F60083 gui=none
    ...
    " -> Cursor line and column hilighting (if enabled)
